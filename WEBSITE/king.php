<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ( $fname == "" || $lname == "" || $address == "" || $contact == "" || $room == "" ) {
            ...
            header("location: king.php?error=1");
...
<div id= "containera">
            ...
            <form method="post" action="king.php">
                <table>
		    <tr>
                        <td><h1>Room Type: </h1></td>
                        <td><input type="text" name="room" class="textInput" style="font-size:18pt;" value="King" readonly ></td>
            </tr>
                    <tr>
