...
if(isset($_SESSION['userId']) && $_SESSION['usertype'] != '1'){
	$query = sprintf("SELECT t.col_dateofpurchase as date,sum(o.col_subtotal) as sales FROM tbl_transaction t
...
if ( isset( $_POST['submit'] ) )
{
	...
	$todate = $_POST["todate"];
	$query = sprintf("SELECT col_dateofpurchase as date,sum(o.col_subtotal) as sales 
	...
	if(isset($_SESSION['userId']) && $_SESSION['usertype'] != '1'){
	$query = sprintf("SELECT t.col_dateofpurchase as date,t.sum(o.col_subtotal) as sales FROM tbl_transaction t
	inner join tbl_order o on o.col_transactionid = t.col_transactionid 
	inner join tbl_product p on o.col_productid = p.col_productid 
	inner join tbl_brandpartner b on b.col_useraccountsid = p.col_useraccountsid 
	where b.col_useraccountsid = " . $_SESSION['userId'] . 
