...
--
-- Truncate table before insert `tbl_brandpartner`
--

TRUNCATE TABLE `tbl_brandpartner`;
--
...
--
-- Truncate table before insert `tbl_damage`
--
...
--
-- Truncate table before insert `tbl_transaction`
--
...
--
-- Truncate table before insert `tbl_useraccounts`
--

TRUNCATE TABLE `tbl_useraccounts`;
--
