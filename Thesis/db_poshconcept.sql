...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2018 at 06:02 AM
...
--
CREATE DATABASE IF NOT EXISTS `db_poshconceptstorefinal` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_poshconceptstorefinal`;
...
--
ALTER TABLE `tbl_brandpartner`
  MODIFY `col_useraccountsid` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_product`
  MODIFY `col_productid` int(11) NOT NULL AUTO_INCREMENT;
--
